...
import com.example.bugfreeram.samyak.Custom.ImageResizer;
import com.example.bugfreeram.samyak.Models.MyImage;
import com.example.bugfreeram.samyak.R;
import com.example.bugfreeram.samyak.databaseCustom.DAOdb;
...
public class DisplayImage extends Activity {
    ...
    public void btnBackOnClick(View v) {
        startActivity(new Intent(this, SelectImage.class));
        finish();
    }
